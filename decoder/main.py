...
def parse():
    ...
    parser.add_argument('-e', '--epoch', type=int, default=10, help='Train the model with e epochs')
    parser.add_argument('-p', '--print', type=int, default=1000, help='Print every p batches')
    ...
    parser.add_argument('-be', '--beam', type=int, default=4, help='Hidden size in encoder and decoder')
